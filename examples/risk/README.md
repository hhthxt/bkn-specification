...
本示例展示基于 **tag** 的风险相关定义与 Action 的 **动态 risk 属性**（allow / not_allow / unknown）。
...
将按表格中的多条策略（如 SEC-T-01 月末封网、SEC-R-01 核心产线防危化、SEC-C-02 雪崩防波及等）输出对应 scenario + action 的 allow/not_allow/unknown 结果。
